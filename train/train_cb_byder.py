...
# Number of rounds and seeds configuration
num_rounds_list = [1000, 2000]
...
if __name__ == "__main__":
    ...
    for i, num_rounds in enumerate(num_rounds_list):
        ...
        config['m'] = 'all' if config['N'] is None else 'mul'
        config['num_rounds'] = num_rounds

        # Log current iteration
        textb = f'{i+1}/{Lnum_rounds_list} @{num_rounds} num_rounds'
        print_context(textb)
